...
class StatusBarItem {
    ...
    RunLoginCommand() {
        ...
        if (this.AwsLoginShellCommand) {
            ...
            // }
            // `;
            let exitCommandBash = "echo 'Terminal Will Close In 5 Secs'; sleep 5; exit 0";
            let exitCommandWindows = "Write-Output 'Terminal Will Close In 5 Secs'; Start-Sleep -Seconds 5; exit 0";
    ...
    static OnTimerTicked() {
        if (StatusBarItem.Current.HasExpiration) {
            ...
            tooltipLastline += StatusBarItem.Current.GetBoolChar(StatusBarItem.Current.IsCopyCredentialsToDefaultProfile) + "Copy to Default Profile ";
            StatusBarItem.Current.ToolTip += "\n" + tooltipLastline;
    ...
    static async StatusBarClicked() {
        ...
        vscode.commands.executeCommand(ProfileWebview_1.ProfileWebview.OpenCommand);
    }
